...
def getFig2(dfMerged):
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=dfMerged['ym'], y=dfMerged['아파트매매실거래가격지수'], mode='lines+markers', name='아파트매매실거래가격지수'))
    fig.add_trace(go.Scatter(x=dfMerged['ym'], y=dfMerged['착공_아파트'], mode='lines+markers', name='착공(아파트)'))
    return fig

def getFig3(dfMerged):
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=dfMerged['ym'], y=dfMerged['아파트매매실거래가격지수'], mode='lines+markers', name='아파트매매실거래가격지수'))
    fig.add_trace(go.Scatter(x=dfMerged['ym'], y=dfMerged['분양_합계'], mode='lines+markers', name='분양'))
    return fig

def getFig4(dfMerged):
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=dfMerged['ym'], y=dfMerged['아파트매매실거래가격지수'], mode='lines+markers', name='아파트매매실거래가격지수'))
    fig.add_trace(go.Scatter(x=dfMerged['ym'], y=dfMerged['준공_아파트'], mode='lines+markers', name='준공(아파트)'))
    return fig
